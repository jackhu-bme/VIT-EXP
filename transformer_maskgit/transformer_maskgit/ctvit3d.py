...
# from transformer_maskgit.attention import ContinuousPositionBias
...
class CTViT3D(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        # to use a pure ct vit 3d, the conv block is removed, named as "peg"
    ...
    def encode(
        ...
        # use a standard transformer with flash attention implementation for now
        # by jack hu
